...
<a class="btn btn-success btn-fill" href="<?php echo base_url('gudang/inventori_in'); ?>"><p>Inventori Masuk</p></a>
<a class="btn btn-danger btn-fill" href="<?php echo base_url('gudang/inventori_out'); ?>"><p>Inventori Keluar</p></a>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
        <a  href="<?php echo base_url();?>gudang/delete_inventori_out/<?php echo $row->id_item_out; ?>" class="btn btn-default"  >Yes</a>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
        <a  href="<?php echo base_url();?>gudang/delete_inventori_in/<?php echo $row->id_item_in; ?>" class="btn btn-default"  >Yes</a>
      <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
    </div>
  </div>
</div>
