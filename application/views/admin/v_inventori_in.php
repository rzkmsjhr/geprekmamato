...
<div class="card">
    ...
    <div class="content">
        <form id="submit-item-in">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Masukkan Jumlah Masuk" name="jumlah" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                <button class="btn btn-fill btn-success" type="submit" id="hide-submit-item-in">Submit</button>
