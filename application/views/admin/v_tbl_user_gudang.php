...
<a class="btn btn-success btn-fill pull-left" href="<?php echo base_url('admin/add_user_gudang'); ?>"><p>Tambah User Gudang</p></a>
<?php 
foreach($usergudang as $row)
{ ?>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
        <a  href="<?php echo base_url();?>admin/delete_gudang/<?php echo $row->id_user; ?>" class="btn btn-default"  >Yes</a>
