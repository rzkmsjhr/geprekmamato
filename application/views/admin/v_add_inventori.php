...
<div class="card">
    <div class="header">
        <h4 class="title">Input Inventori</h4>
    </div>
    <div class="content">
        <form id="submit-item">
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input class="form-control" readonly="readonly" type="text" name="kode_item1" value="INV">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger btn-fill" href="<?php echo base_url('admin/mastergudang'); ?>">Kembali</a>
            </div>
