...
<a class="btn btn-success btn-fill pull-left" href="<?php echo base_url('admin/add_user_kasir'); ?>"><p>Tambah Kasir</p></a>
<?php 
foreach($userkasir as $row)
{ ?>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
        <a  href="<?php echo base_url();?>admin/delete_kasir/<?php echo $row->id_user; ?>" class="btn btn-default"  >Yes</a>
