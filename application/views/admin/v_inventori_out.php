...
<div class="card">
    <div class="header">
        <h4 class="title">Input Inventori Keluar</h4>
    </div>
    <div class="content">
        <form id="submit-item-out">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tanggal-beli" type="text" class="form-control" placeholder="Masukkan Tanggal Keluar" name="tanggal_keluar" required>
                    </div>
                    <div class="form-group">
                        <label>Jumlah Keluar</label>
                        <input type="number" class="form-control" placeholder="Masukkan Jumlah Keluar" name="jumlah" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger btn-fill" href="<?php echo base_url('admin/inventori'); ?>">Kembali</a>
            </div>
