          ...
          <tbody>
              ...
              <?php }?>
                <tr>
                  ...
                  <td style="background-color: #"><?php echo "$total_price"; ?></td></tr>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
                  <td style="background-color: #">Diskon</td>
                  <td style="background-color: #"><?php echo "$diskon"; ?></td></tr>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
                  <td style="background-color: #F48024">Total Bayar</td>
                  <td style="background-color: #F48024"><?php echo "$total_bayar"; ?></td></tr>
                </tr>
            </tbody>
        </table>
    </div>
...
<a class="btn btn-danger btn-fill" href="<?php echo base_url('kasir/add_transaksi'); ?>">Kembali</a>
</form>